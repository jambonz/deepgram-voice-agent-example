        ...
        .llm({
          ...
          llmOptions: {
            Settings: {
              type: 'Settings',
              agent: {
                greeting: 'Hello, I am your virtual assistant. How can I help you today?',
                listen: {
                  provider: {
                    type: 'deepgram',
                    model: 'nova-2'
                ...
                think: {
                  ...
                  prompt: "You are a helpful assistant. You will be asked to answer questions and provide information.",
                  functions: [
                    {
                      name: 'get_weather',
